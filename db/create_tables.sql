...
IF NOT EXISTS (SELECT * FROM 'academics') INSERT INTO `academics` VALUES (1, 'Bob Dole', 'University of Bradford', 'Metaphysics'),(2, 'Gisela Joseph','Zombie College', 'Magic History' ),(3, 'Durga Van As', 'Unseen University', 'Foreign Life Gardening'),
...
IF NOT EXISTS (SELECT * FROM 'papers') INSERT INTO `papers` VALUES 
...
IF NOT EXISTS (SELECT * FROM 'authors') INSERT INTO `authors` VALUES (1, 1, 7), (2, 2, 7), (3, 3, 5), (4, 4, 3), (5, 5, 19), (6, 6, 9), (7, 7, 8), (8, 8, 4), (9, 9, 20), (10, 10, 19), (11, 11, 18), (12, 12, 17), (13, 13, 16), (14, 14, 15), (15, 15, 14),
